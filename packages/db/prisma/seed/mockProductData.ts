...
import { MOCK_PRODUCT_ID } from "../../src/mockProductId";
    ...
    marketingTasks: [
      {
        ...
        scheduledStart: new Date("2026-08-15T09:00:00.000Z"),
        scheduledEnd: new Date("2026-08-15T10:00:00.000Z"),
      },
      {
        ...
        scheduledStart: new Date("2026-08-22T09:00:00.000Z"),
        scheduledEnd: new Date("2026-08-22T10:00:00.000Z"),
      },
      {
      ...
      },
      {
        ...
        scheduledStart: new Date("2026-11-30T09:00:00.000Z"),
        scheduledEnd: new Date("2026-11-30T10:00:00.000Z"),
      },
      {
        ...
        scheduledStart: new Date("2027-01-31T09:00:00.000Z"),
        scheduledEnd: new Date("2027-01-31T10:00:00.000Z"),
      },
    ],
    sentiments: [
      {
...
export const mockProductData = getMockProductData();

export {MOCK_PRODUCT_ID} from "../../src/mockProductId";
